...
# Thor (R38.2.1) BSP does not include brcm_patchram_plus
...
do_install() {
    ...
    # in the R38.2.1 BSP and may not be needed for SBSA/server architecture
...
#
# Thor (R38.2.1) may use mainline Bluetooth stack without patchram utility
