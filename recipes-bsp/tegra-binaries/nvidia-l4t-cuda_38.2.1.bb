...
DESCRIPTION = "CUDA driver libraries from NVIDIA L4T R38.2.1 for Jetson Thor"
LICENSE = "CLOSED"
LIC_FILES_CHKSUM = ""
...
SRC_URI = "file://nvidia-l4t-cuda_38.2.1-20250910123945_arm64.deb;subdir=${BP} \
           file://nvidia-l4t-cuda-utils_38.2.1-20250910123945_arm64.deb;subdir=${BP}"
...
do_unpack:append() {
    ...
    for deb in ['nvidia-l4t-cuda_38.2.1-20250910123945_arm64.deb',
                'nvidia-l4t-cuda-utils_38.2.1-20250910123945_arm64.deb']:
