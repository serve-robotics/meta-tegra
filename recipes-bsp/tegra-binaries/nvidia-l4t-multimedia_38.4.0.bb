...
DESCRIPTION = "Multimedia libraries (NvMM, NvMedia, NvVideo) from NVIDIA L4T R38.4.0 for Jetson Thor"
LICENSE = "CLOSED"
LIC_FILES_CHKSUM = ""
...
SRC_URI = "file://nvidia-l4t-multimedia_38.4.0-20251230160601_arm64.deb;subdir=${BP} \
           file://nvidia-l4t-multimedia-utils_38.4.0-20251230160601_arm64.deb;subdir=${BP}"
...
do_unpack:append() {
    ...
    for deb in ['nvidia-l4t-multimedia_38.4.0-20251230160601_arm64.deb',
                'nvidia-l4t-multimedia-utils_38.4.0-20251230160601_arm64.deb']:
