...
DESCRIPTION = "Prebuilt nvidia display driver modules and GSP firmware for tegra264-display (R38.4.0)"
LICENSE = "Proprietary"
...
# Source: L4T R38.4.0 BSP package
SRC_URI = " \
    https://developer.nvidia.com/downloads/embedded/L4T/r38_Release_v4.0/release/Jetson_Linux_R38.4.0_aarch64.tbz2;name=l4t_bsp \
"
...
do_install() {
    ...
    OPENRM_DEB="${S}/kernel/openrm/nvidia-l4t-kernel-openrm_6.8.12-tegra-38.4.0-20251230160601_arm64.deb"
    ...
    FW_DEB="${S}/nv_tegra/l4t_deb_packages/openrm/nvidia-l4t-firmware-openrm_38.4.0-20251230160601_arm64.deb"
    if [ -f "${FW_DEB}" ]; then
    ...
    INIT_DEB="${S}/nv_tegra/l4t_deb_packages/openrm/nvidia-l4t-init-openrm_38.4.0-20251230160601_arm64.deb"
    if [ -f "${INIT_DEB}" ]; then
