# GStreamer plugins-bad 1.24.12 for Jetson Thor
# Required for NVIDIA GStreamer plugins

require ${COREBASE}/meta/recipes-multimedia/gstreamer/gstreamer1.0-plugins-common.inc
require ${COREBASE}/meta/recipes-multimedia/gstreamer/gstreamer1.0-plugins-license.inc
...
# GStreamer 1.24 has different meson options than 1.22
# Many options were removed or renamed - only set known-valid options
EXTRA_OEMESON += " \
    -Ddoc=disabled \
