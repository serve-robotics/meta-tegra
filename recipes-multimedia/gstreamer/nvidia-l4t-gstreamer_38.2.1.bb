...
Using R38.2.1 version for GLib 2.78 compatibility."
LICENSE = "CLOSED"
LIC_FILES_CHKSUM = ""
...
# R38.2.1 version used for GLib 2.78 compatibility (38.4.0 requires GLib 2.80+)
SRC_URI = "file://nvidia-l4t-gstreamer_38.2.1-20250910123945_arm64.deb;subdir=${BP}"
...
do_unpack:append() {
    ...
    deb = 'nvidia-l4t-gstreamer_38.2.1-20250910123945_arm64.deb'
